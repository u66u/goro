...
#define _GO_0(FUNC) coro_spawn((void (*)(void*))FUNC, NULL)
...
#define _GO_3(FUNC, A1, A2, A3) ({ \
    ...
    struct args_3 { _T1 a; _T2 b; _T3 c; }; \
    struct args_3* args = malloc(sizeof(struct args_3)); \
    args->a = (A1); args->b = (A2); args->c = (A3); \
    void _wrapper(void* p) { \
...
// structs can only be passed by pointers
#define GO(FUNC, ...) \
